...
const AtividadeEixo = require('../models/AtividadeEixo')
...
controller.novo = async (req, res) => {
    try {
        ...
        await AtividadeEixo.create(req.body)
        // HTTP 201: Created
        res.status(201).end()
    }
    catch (erro) {
...
controller.listar = async (req, res) => {
    try {
        ...
        let dados = await AtividadeEixo.find()
        .populate('eixo')
        .populate('atividade')
...
controller.obterUm = async (req, res) => {
    ...
    let obj = await AtividadeEixo.findById(id)
...
controller.atualizar = async (req, res) => {
    try {
        ...
        let obj = await AtividadeEixo.findByIdAndUpdate(id, req.body)
...
controller.excluir = async (req, res) => {
    try {
        ...
        const id = req.body._id
        let obj = await AtividadeEixo.findByIdAndDelete(id)
