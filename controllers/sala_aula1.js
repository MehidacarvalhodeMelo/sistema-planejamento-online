...
const SalaAula1 = require('../models/SalaAula1')
...
controller.novo = async (req, res) => {
    try {
        ...
        await SalaAula1.create(req.body)
        // HTTP 201: Created
        res.status(201).end()
    }
    catch (erro) {
...
controller.listar = async (req, res) => {
    try {
        ...
        let dados = await SalaAula1.find()
...
controller.obterUm = async (req, res) => {
    ...
    let obj = await SalaAula1.findById(id)
...
controller.atualizar = async (req, res) => {
    try {
        ...
        let obj = await SalaAula1.findByIdAndUpdate(id, req.body)
...
controller.excluir = async (req, res) => {
    try {
        ...
        const id = req.body._id
        let obj = await SalaAula1.findByIdAndDelete(id)
