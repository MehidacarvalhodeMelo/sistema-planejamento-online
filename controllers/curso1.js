...
const Curso1 = require('../models/Curso1')
...
controller.obterUm = async (req, res) => {
    ...
    let obj = await Curso1.findById(id)
...
controller.atualizar = async (req, res) => {
    try {
        ...
        let obj = await Curso1.findByIdAndUpdate(id, req.body)
...
controller.excluir = async (req, res) => {
    try {
        ...
        const id = req.body._id
        let obj = await Curso1.findByIdAndDelete(id)
